...
{{--                        <a--}}
{{--                            href="{{ route('register') }}"--}}
{{--                            class="inline-block px-5 py-1.5 bg-[#F53003] dark:bg-[#FF4433] text-white rounded-sm text-sm font-medium hover:opacity-90">--}}
{{--                            Register--}}
{{--                        </a>--}}
{{--                    @endif--}}
{{--                @endauth--}}
...
{{--    </div>--}}
{{--</header>--}}
{{--<main class="lg:max-w-7xl mx-auto px-6 lg:px-20 py-12 lg:py-16 w-full flex items-center justify-center lg:grow">--}}

{{--    <div class="w-full max-w-[335px] lg:max-w-4xl">--}}
{{--        <div class="p-6 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-lg text-center">--}}

{{--            <svg class="w-16 h-16 text-[#F53003] dark:text-[#FF4433] mx-auto mb-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">--}}
{{--                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.008v.008H12v-.008Z" />--}}
{{--            </svg>--}}
...
{{--                Silakan <strong>Log In</strong> atau <strong>Register</strong> menggunakan link di pojok kanan atas untuk memulai.--}}
{{--            </p>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--</main>--}}
...
{{--<footer class="w-full py-4 text-center text-xs text-[#706f6c] dark:text-[#A1A09A]">--}}
