...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    Route::get('/dashboard', [AdminLaporanController::class, 'dashboard'])->name('admin.dashboard');

    // RUTE REPORTS & EKSPOR PDF (TAMBAHAN DISINI)
    Route::get('/laporan/reports', [AdminLaporanController::class, 'reports'])->name('admin.laporan.reports');
    Route::get('/laporan/export-pdf', [AdminLaporanController::class, 'exportPdf'])->name('admin.laporan.exportPdf');
...
Route::middleware('auth:polisi')->prefix('polisi')->name('polisi.')->group(function () {
    Route::get('/dashboard', [PolisiDashboardController::class, 'index'])->name('dashboard');
    Route::get('/laporan/{id}', [PolisiDashboardController::class, 'show'])->name('laporan.show');
    Route::get('/profil', [PolisiDashboardController::class, 'profil'])->name('profil');
    ...
    Route::post('/laporan/{id}/status', [PolisiDashboardController::class, 'updateStatus'])->name('laporan.status');
    Route::post('/laporan/{id}/tangani', [PolisiDashboardController::class, 'tangani'])->name('laporan.tangani');
    Route::get('/laporan/{id}/edit', [PolisiDashboardController::class, 'editLaporan'])->name('laporan.edit');
    Route::put('/laporan/{id}', [PolisiDashboardController::class, 'updateStatus'])->name('laporan.update');
});
