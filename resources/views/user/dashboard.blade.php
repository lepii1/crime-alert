    ...
    <div class="main-content-wrapper py-4 flex justify-between items-center">
        <div class="flex items-center group">
            <a href="{{ url('/') }}" class="flex items-center">
                ...
                <span class="text-white text-xl font-semibold"> CRIME ALERT - DASHBOARD</span>
            </a>
        </div>

        <div class="flex items-center space-x-3">
            <nav class="hidden lg:flex items-center space-x-2">
                <a href="{{ route('user.home') }}" class="px-5 py-2 bg-gray-600 text-white rounded-xl font-bold text-xs hover:bg-gray-700 transition uppercase tracking-wider hidden sm:flex items-center shadow-lg">
                    Beranda
                </a>
            </nav>
